...
class JsonApiDriver(BaseDriver):
    ...
    def fetch_metadata(self, url: str) -> Dict:
        # Single-chapter: extract chapter_id
    ...
    def list_pages(self, metadata: Dict) -> List[str]:
        # Mangadex serves images via uploads.mangadex.org
    ...
    def list_chapters(self, title_url: str) -> List[Dict]:
        """
        Use the /feed endpoint to page through all chapters of a title.
        Returns list of dicts with keys: url, volume, chapter, title, language.
        """
